public class NormalCell : Cell
{
    private List<List<string>> normalTerrain = new List<List<string>>
    {
        ...
        new List<string>{"forest","tall pine trees swaying in the gentle breeze.","like you are being watched. But probably not.","50","45","beast,plant,fey"},
        new List<string>{"plains","rolling hills of tall, browning grass. The sun beats down on you.","like you miss your mom.","45","30","beast,plant,humanoid"}
    };
